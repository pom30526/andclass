package kr.co.company.telephonytest;
...
public class TelephonyTestActivity extends Activity {
	private TelephonyManager manager;
	PhoneStateListener listener = new PhoneStateListener() {
		public void onCallStateChanged(int state, String incomingNumber) {
			Toast.makeText(TelephonyTestActivity.this,
					"상태:  " + state + "전화번호: " + incomingNumber, 0).show();

		}

		public void onDataActivity(int direction) {
			Toast.makeText(TelephonyTestActivity.this, "방향 : " + direction, 0).show();
		}
	};
